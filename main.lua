...
--ZELF AANGEPAST
-- Starting Apartment 
exports('CreateApartmentFurnished', function(spawn, house)
    if house == "apartment1" then --V3 appa basic
        local objects = {}
        local POIOffsets = {}
        POIOffsets.exit = json.decode('{"z":1.0,"y":-3.482178,"x":-3.9,"h":173.785736}')
    ...
    elseif house == "apartment2" then -- Mid
        local objects = {}
        local POIOffsets = {}
        POIOffsets.exit = json.decode('{"x": -0.400192, "y": -2.408508, "z": -1.524590, "h": 88.635841}')
    ...
    elseif house == "apartment3" then -- highend
